  ...
  return (
    <>
      <div className="scene" aria-hidden="true">
        <div className="scene__edge-breathe" />
        <svg className="scene__edge-svg" viewBox="0 0 100 100" preserveAspectRatio="none">
          <rect className="scene__edge-trail scene__edge-trail--glow" x="0.8" y="0.8" width="98.4" height="98.4" rx="2.6" ry="2.6" pathLength="100" />
          <rect className="scene__edge-trail scene__edge-trail--core" x="0.8" y="0.8" width="98.4" height="98.4" rx="2.6" ry="2.6" pathLength="100" />
        </svg>
