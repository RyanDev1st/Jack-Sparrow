...
export default function ZoneCircle({ color, style, className = '', selected = false, label, anchored = true }: ZoneCircleProps) {
  return (
    <div
      style={{
        ...style,
      ...
      className={`relative rounded-[999px] border-2 backdrop-blur-[1px] ${anchored ? '-translate-x-1/2 -translate-y-1/2' : ''} ${className}`}
    >
      <motion.span
        aria-hidden="true"
